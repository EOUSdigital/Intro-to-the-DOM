...
//  4. (Stretch) Toggle a class between on every element sibling between the first and last card (loop using nextElementSibling).
...
//  • Don’t over-traverse: If a single selector can grab what you want, use it (.grid > .card:nth-child(2))—traversal is for when you already have a reference and want relative movement.
